...
const benefits = [
  {
    title: "Free for B2 Candidates",
    description: "B2 certified nurses pay absolutely nothing — no fees, no deposits. Already have B2? Your path to Germany is completely free of cost.",
    icon: (
