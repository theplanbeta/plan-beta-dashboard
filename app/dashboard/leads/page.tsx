    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">Manage and convert leads to students</p>
        </div>
        ...
        <div className="md:hidden space-y-3 p-3">
          {filteredAndSortedLeads.length === 0 ? (
            ...
            filteredAndSortedLeads.map((lead) => (
              <div key={lead.id} className="bg-gray-50 dark:bg-gray-700 rounded-xl p-5 space-y-4 border border-gray-200 dark:border-gray-600">
                {/* Name & Badges */}
                ...
                <div className="space-y-2.5 bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-semibold text-gray-900 dark:text-white">{lead.whatsapp}</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">{lead.contactAttempts} contact attempts</div>
                    </div>
                  </div>
                  {lead.email && (
                    <div className="flex items-center gap-3 pt-2 border-t dark:border-gray-700">
                      <span className="text-xl">📧</span>
                      <div className="text-sm text-gray-700 dark:text-gray-300 break-all">{lead.email}</div>
                    </div>
                  )}
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {lead.followUpDate && (
                      <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-600">
                        <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">Follow-up</div>
                    ...
                    {lead.interestedLevel && (
                      <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-600">
                        <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">Interested</div>
                        <div className="text-sm font-semibold text-gray-900 dark:text-white">{lead.interestedLevel}</div>
                        {lead.interestedBatch && (
                          <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">{lead.interestedBatch.batchCode}</div>
                        )}
                      </div>
                    )}
                  </div>
              ...
              {filteredAndSortedLeads.map((lead) => (
                <tr key={lead.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm text-gray-900 dark:text-white">{lead.whatsapp}</div>
                    {lead.email && (
                  ...
                  <td className="px-6 py-4">
                    {lead.interestedLevel && (
                      <div className="text-sm text-gray-900 dark:text-white">{lead.interestedLevel}</div>
                    )}
                    {lead.interestedBatch && (
                  ...
                  <td className="px-6 py-4">
                    {lead.followUpDate ? (
                      ...
                      <div className="text-sm text-gray-400 dark:text-gray-500">Not set</div>
                    )}
