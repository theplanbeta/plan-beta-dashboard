    ...
    >
      ...
      <div className="flex gap-2 pt-3 border-t border-white/[0.06]">
        ...
        <a
          ...
          className="flex-1 text-center py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-all inline-flex items-center justify-center gap-1.5"
        >
