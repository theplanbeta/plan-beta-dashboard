    ...
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0a0a0a]">
        ...
        <motion.div
          ...
          className="blur-orb absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-primary/15 rounded-full blur-[80px]"
        />
        <motion.div
          animate={{ y: [0, 20, 0], scale: [1, 1.05, 1] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 1 }}
          className="blur-orb absolute bottom-1/4 right-1/3 w-[300px] h-[300px] bg-blue-500/10 rounded-full blur-[80px]"
        />
