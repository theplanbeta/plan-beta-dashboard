    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Mark attendance for entire batch at once</p>
        </div>
        <Link
            ...
            <div className="space-y-3">
              {selectedBatch.students.map((student) => {
                ...
                return (
                  <div
                    key={student.id}
                    className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg space-y-3 md:space-y-0"
                  >
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <input
                        ...
                        className="px-3 py-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-primary text-sm w-40"
                      />
                    </div>
                  </div>
                )
