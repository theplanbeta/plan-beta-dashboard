...
export const TARGET_KEYWORDS = {
  ...
  nursingJobs: [
    'nursing jobs germany indian nurses',
    'krankenpflege jobs berlin',
    'altenpflege jobs germany b2',
    'bsc nursing germany jobs',
    'nurse jobs germany salary',
    'nursing in germany requirements',
    'german for nurses b2',
    'nursing recruitment germany',
    'healthcare jobs germany visa sponsorship',
  ],
  engineeringJobs: [
    'engineering jobs germany visa sponsorship',
    'mechanical engineer germany blue card',
    'electrical engineer jobs berlin',
    'software engineer germany',
    'IT jobs germany for indians',
    'ingenieur jobs deutschland',
    'engineering jobs munich',
    'blue card germany engineer',
  ],
  studentJobs: [
    'werkstudent jobs berlin english',
    'mini job germany students',
    'part time jobs germany international students',
    'student jobs hamburg',
    'nebenjob germany',
    'aushilfe jobs germany',
    'student jobs munich english',
    'working student germany',
  ],
  indiaJobs: [
    'how to get job in germany from india',
    'germany work visa indian professionals',
    'germany job for indian freshers',
    'work in germany from india salary',
    'germany jobs for indians 2026',
    'skilled worker visa germany india',
  ],
}
