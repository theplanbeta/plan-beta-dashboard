          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-16">
            <AnimateInView delay={0.1} direction="left">
              <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm text-center hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">BSc / GNM Nursing</h3>
                <p className="text-gray-600">BSc Nursing or GNM Nursing degree. Freshers and experienced nurses welcome.</p>
              </div>
            </AnimateInView>
