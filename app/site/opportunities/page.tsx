...
export default function OpportunitiesPage() {
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="#sectors"
                className="inline-flex items-center px-6 py-3 border border-white/[0.1] text-white rounded-lg font-semibold hover:bg-gray-800 transition-all"
              >
      ...
      {/* Sectors */}
      <section id="sectors" className="py-20 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white mb-4">High-Demand Sectors</h2>
              ...
              >
                <div className="p-8">
                  <div className="flex flex-col lg:flex-row lg:items-start gap-8">
                    ...
                    <div className="lg:w-1/3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center text-sm">
                          ...
                          <span className="font-semibold text-white">{sector.salary}</span>
                        </div>
                        <div className="flex items-center text-sm">
                          <span className="text-gray-500 w-24">Required:</span>
                          <span className="font-semibold text-white">{sector.requirements}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Path */}
                    <div className="lg:w-1/3">
                      <h4 className="font-semibold text-white mb-4">Your Path</h4>
      ...
      <section className="py-20 bg-[#111]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white mb-4">Visa Options</h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {visaTypes.map((visa, index) => (
              <div key={index} className="bg-white/[0.04] border border-white/[0.08] rounded-xl p-6">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    <span className="text-gray-300">{visa.requirements}</span>
                  </div>
                  <div>
      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white mb-4">Why Germany?</h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">Europe&apos;s largest economy with stable employment and strong social security.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-400">Universal healthcare coverage. One of the best healthcare systems in the world.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-400">Public universities are tuition-free, even for international students.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-400">30 days paid vacation, reasonable working hours, strong worker protections.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-400">Live in the heart of Europe. Easy travel to 26 Schengen countries.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-400">Growing Indian diaspora. Indian stores, restaurants, and cultural events.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#111]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <details key={index} className="group bg-white/[0.04] border border-white/[0.08] rounded-xl">
