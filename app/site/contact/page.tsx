      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="max-w-md text-center">
          ...
          <div className="space-y-4">
            <a
              href="https://wa.me/919876543210?text=Hi%20Plan%20Beta!%20I%20just%20submitted%20a%20contact%20form."
              target="_blank"
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-primary to-red-700 rounded-2xl p-8 text-white">
                ...
                <a
                  href="https://wa.me/919876543210?text=Hi%20Plan%20Beta!%20I'm%20interested%20in%20learning%20German."
                  target="_blank"
                  rel="noopener noreferrer"
