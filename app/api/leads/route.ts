...
const createLeadSchema = z.object({
  ...
  interestedLevel: z.enum(["A1", "A2", "B1", "B2", "SPOKEN_GERMAN"]).optional(),
  interestedType: z.enum(["A1_ONLY", "A1_HYBRID", "A2_ONLY", "B1_ONLY", "B2_ONLY", "SPOKEN_GERMAN", "FOUNDATION_A1_A2", "CAREER_A1_A2_B1", "COMPLETE_PATHWAY"]).optional(),
